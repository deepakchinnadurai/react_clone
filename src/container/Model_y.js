...
export function HeaderBlock1() {
  return (
    <div>
    <div className='headerBlock' style ={ { backgroundImage: "url('https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/model-y-front-34-blue-1552622749.jpg')" } }>
