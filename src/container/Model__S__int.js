...
export function Model_s1() {
  ...
  export function Model_s2(){
     ...
     const [state5,setState5] = useState('none')
      ...
      return(
        ...
        <div  style={{display:"flex"}}>
            <img  style ={{width:"1400px"}} src="https://chargedevs.com/wp-content/uploads/2021/01/S_Glass_Roof-copy.jpg"/>
        </div>
        ...
        <div  style={{position:"relative",bottom:"900px",display:"inline-block",backgroundColor:"black",width:"1350px",height:"800px"}}>
            <img  style ={{width:"1390px",height:"800px"}} src="https://akm-img-a-in.tosshub.com/indiatoday/images/story/202101/2021_Tesla_Model_S_exterior_1200x768.jpeg?jYqGA7xuIf9LJ9SYpyBtero.rH1FnCOa&size=1200:675"/>
     ...
     <div style={{backgroundColor:'black',position:'relative',bottom:'1900px',height:'840px'}}>
       ...
       <h1 style={{color:'white',position:'relative',bottom:'800px',left:'800px'}}>Model S &nbsp;
